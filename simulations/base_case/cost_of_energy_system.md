...
layout: page
title: Base Case
subtitle: Cost Overview
menubar: menu_base_case
menubar_collapsable: True
show_sidebar: false
hero_height: is-small
hero_image: ../../../img/base.jpg
left_link: /simulations/base_case/carbon_balance
left_link_name: CO<sub>2</sub> Balance
right_link: /simulations/base_case/energy_storage
right_link_name: Energy Storage
---

First, have a look at [How to Navigate](../../../navigate) to grasp all the capabilities of the interactive results.

<div pbi-resize="powerbi" pbi-resize-src="https://app.powerbi.com/view?r=eyJrIjoiMmY4Y2EzZWUtYTUyZC00ZjVkLWJkNGUtMzFjMDA5YTIyZWNjIiwidCI6ImRkOTczZjdjLTg0ZjUtNDcwYi05MWQwLTA0M2JlZTg3ZTA3ZiIsImMiOjh9" pbi-resize-min-width="600" pbi-default-width="600px" pbi-default-height="656" pbi-resize-width="16" pbi-resize-height="9" pbi-resize-load-event="page-load" pbi-resize-header="true" pbi-resize-m-src="https://app.powerbi.com/view?r=eyJrIjoiMmY4Y2EzZWUtYTUyZC00ZjVkLWJkNGUtMzFjMDA5YTIyZWNjIiwidCI6ImRkOTczZjdjLTg0ZjUtNDcwYi05MWQwLTA0M2JlZTg3ZTA3ZiIsImMiOjh9" pbi-resize-m-width="9" pbi-resize-m-height="9" style="position: relative;"><iframe frameborder="0" allowfullscreen="true"></iframe></div><script type="text/javascript">
...
The total cost of the energy system is €20.39 billion per year, or €89.34/MWh on average. That includes capital expenses (CAPEX), fixed operations & maintenance (FOM) and variable operations & maintenance (VOM) costs.

The total cost for the electricity system is €7.17 billion per year, or €[x]/MWh. The most expensive technologies by annualized cost are:


<div class="table-container"  markdown="1">

|               | Cost (€ billion per year) | 
|---------------|---------------------------|
| Solar PV      | 1.85                      |
| Wind offshore | 1.64                      | 
| CCGTs         | 1.00                      |
...
The total cost for the hydrogen system is €5.73 billion per year, or €[x]/MWh on average. This is mainly due to H<sub>2</sub> imports from the Netherlands at a fixed cost of  €75/MWh. Electrolysis plants represent only a cost of €0.03 billion per year.

The total cost for the methane system is €7.79 billion per year, or €[x]/MWh on average. This is mainly due to CH4 imports, at a fixed cost of €40/MWh. The production of biomethane costs €[x] billion per year.

The total cost of the CO<sub>2</sub> system is €1.25 billion per year, Or €[x]/tCO<sub>2</sub>. The most expensive technologies by annualized cost are:
